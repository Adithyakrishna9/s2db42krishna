...
router.get('/', function (req, res) { 
    res.render('index', { title: 'Heroines App', user : req.user }); 
}); 
 
router.get('/register', function(req, res) { 
    res.render('register', { title: 'Heroines App Registration'}); 
}); 
...
router.get('/login', function(req, res) { 
    res.render('login', { title: 'Heroines App Login', user : req.user }); 
}); 
